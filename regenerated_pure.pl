...
my $pipeline3 = do { do {
    ...
    sub sort_numeric_0_4 {
        ...
        my $a_num = 0;
        my $b_num = 0;
        if ( scalar @a_fields > 0 && $a_fields[0] =~ /^\d+(?:[.]\d+)?$/msx ) { $a_num = $a_fields[0]; }
        if ( scalar @b_fields > 0 && $b_fields[0] =~ /^\d+(?:[.]\d+)?$/msx ) { $b_num = $b_fields[0]; }
        return $a_num <=> $b_num || $a cmp $b;
    }
    my @sort_sorted_0_4 = sort sort_numeric_0_4 @sort_lines_0_4;
    @sort_sorted_0_4 = reverse @sort_sorted_0_4;
    $output_0 = join "\n", @sort_sorted_0_4;
        if ($output_0 ne q{} && !($output_0 =~ m{\n\z}msx)) {
            $output_0 .= "\n";
        }
...
my $pipeline4 = do { do {
    ...
    my @xargs_input_0_2 = split /\s+/msx, $output_0;
    my @xargs_output_0_2;
...
my $pipeline5 = do { do {
    ...
    @sort_sorted_0_2 = reverse @sort_sorted_0_2;
    $output_0 = join "\n", @sort_sorted_0_2;
        if ($output_0 ne q{} && !($output_0 =~ m{\n\z}msx)) {
            $output_0 .= "\n";
        }
...
my $pipeline8 = do { do {
    ...
    @ls_files_1 = map { ( -f $_ ? '-' : ( -d $_ ? 'd' : '?' ) ) . ' ' . $_ } @ls_files_1;
    (@ls_files_1 ? join("\n", @ls_files_1) . "\n" : q{});
    };
    my $grep_result_0_1;
    my @grep_lines_0_1 = split /\n/msx, $output_0;
...
my $pipeline10 = do { do {
    ...
    sub sort_numeric_0_3 {
        ...
        my $a_num = 0;
        my $b_num = 0;
        if ( scalar @a_fields > 2 && $a_fields[2] =~ /^\d+(?:[.]\d+)?$/msx ) { $a_num = $a_fields[2]; }
        if ( scalar @b_fields > 2 && $b_fields[2] =~ /^\d+(?:[.]\d+)?$/msx ) { $b_num = $b_fields[2]; }
        return $a_num <=> $b_num || $a cmp $b;
    }
    my @sort_sorted_0_3 = sort sort_numeric_0_3 @sort_lines_0_3;
    @sort_sorted_0_3 = reverse @sort_sorted_0_3;
...
my $pipeline11 = do { do {
    ...
    my @xargs_input_0_1 = split /\s+/msx, $output_0;
    my @xargs_output_0_1;
...
my $pipeline12 = do { do {
    ...
    sub sort_numeric_0_2 {
        ...
        my $a_num = 0;
        my $b_num = 0;
        if ( scalar @a_fields > 3 && $a_fields[3] =~ /^\d+(?:[.]\d+)?$/msx ) { $a_num = $a_fields[3]; }
        if ( scalar @b_fields > 3 && $b_fields[3] =~ /^\d+(?:[.]\d+)?$/msx ) { $b_num = $b_fields[3]; }
        return $a_num <=> $b_num || $a cmp $b;
    }
    my @sort_sorted_0_2 = sort sort_numeric_0_2 @sort_lines_0_2;
    @sort_sorted_0_2 = reverse @sort_sorted_0_2;
