...
my $sed_output = `sed 's/line/LINE/g' test_sed.txt`;
print $sed_output;
...
my $sed_delete = `sed '3d' test_sed.txt`;
print $sed_delete;
...
my $sed_append = `sed '2a\\APPENDED LINE' test_sed.txt`;
print $sed_append;
...
my $sed_multi = `sed 's/line/LINE/g; s/This/THAT/g' test_sed.txt`;
print $sed_multi;
...
my $sed_regex = `sed 's/\bline\b/LINE/g' test_sed_backup.txt`;
print $sed_regex;
...
my $sed_global = `sed 's/line/LINE/g' test_sed_backup.txt`;
print $sed_global;
...
my $sed_range = `sed '2,4s/line/LINE/g' test_sed_backup.txt`;
print $sed_range;
