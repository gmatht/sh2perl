...
if (-f "test_cp_dest.txt") {
    ...
    my $content = `cat test_cp_dest.txt`;
...
print "\ncp with preserve (-p):\n";
my $cp_preserve = `cp -p test_cp_source.txt test_cp_preserve.txt`;
...
print "\ncp with force (-f):\n";
my $cp_force = `cp -f test_cp_source.txt test_cp_force.txt`;
...
print "\ncp with update (-u):\n";
my $cp_update = `cp -u test_cp_source.txt test_cp_update.txt`;
...
my $cp_suffix = `cp --suffix=.bak test_cp_source.txt test_cp_suffix.txt`;
...
my $cp_all = `cp -a test_cp_source.txt test_cp_all.txt`;
