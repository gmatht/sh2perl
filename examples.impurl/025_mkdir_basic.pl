...
my $mkdir_mode = `mkdir -m 755 test_mkdir_mode`;
...
my $mkdir_multi = `mkdir test_mkdir_multi1 test_mkdir_multi2 test_mkdir_multi3`;
...
my $mkdir_pv = `mkdir -p -v test_mkdir_pv/subdir1/subdir2`;
print $mkdir_pv;
...
my $mkdir_777 = `mkdir -m 777 test_mkdir_777`;
if (-d "test_mkdir_777") {
...
my $mkdir_error = `mkdir test_mkdir_error 2>&1`;
