...
The PowerShell script `scripts\wasm.ps1` automates the process of building and running the WASM version of the debashc project.
...
```powershell
# Use Edge
.\scripts\wasm.ps1 -Browser edge

# Use Chrome
.\scripts\wasm.ps1 -Browser chrome

# Use default browser
.\scripts\wasm.ps1 -Browser default
```

### Specify Port
```powershell
# Use a different port (default is 8000)
.\scripts\wasm.ps1 -Port 8080
```

### Combined Parameters
```powershell
.\scripts\wasm.ps1 -Browser edge -Port 8080
```
