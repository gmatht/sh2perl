...
#!/usr/bin/perl
BEGIN { $0 = "/home/runner/work/sh2perl/sh2perl/examples.impurl/028_dirname_basic.pl" }


print "=== Example 028: Basic dirname command ===\n";

print "Using backticks to call dirname:\n";
my $dirname_output = __bt(do { my $dirname_cmd = 'dirname /path/to/file.txt'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
...
my $dirname_current = __bt(do { my $dirname_cmd = 'dirname .'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
...
my $dirname_root = __bt(do { my $dirname_cmd = 'dirname /'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
...
my $dirname_relative = __bt(do { my $dirname_cmd = 'dirname ../file.txt'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
...
my $dirname_root_file = __bt(do { my $dirname_cmd = 'dirname /file.txt'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
...
my $dirname_nested = __bt(do { my $dirname_cmd = 'dirname /a/b/c/d/e/file.txt'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
...
my $dirname_multi = __bt(do { my $dirname_cmd = 'dirname /usr/local/bin/script.sh'; my $dirname_output = qx{$dirname_cmd}; $CHILD_ERROR = $? >> 8; $dirname_output; }
);
