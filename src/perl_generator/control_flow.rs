...
impl PerlGenerator {
    ...
    pub fn generate_while_loop(&mut self, while_loop: &WhileLoop) -> String {
        ...
        self.indent_level += 1;
        output.push_str(&self.indent());
        output.push_str(&self.generate_block_commands(&while_loop.body));
        self.indent_level -= 1;
    ...
    pub fn generate_for_loop(&mut self, for_loop: &ForLoop) -> String {
        ...
        let items: Vec<String> = for_loop.items.iter()
            .map(|word| self.word_to_perl(word))
            .collect();
        ...
        self.indent_level += 1;
        output.push_str(&self.indent());
        output.push_str(&self.generate_block_commands(&for_loop.body));
        self.indent_level -= 1;
    ...
    pub fn generate_function(&mut self, func: &Function) -> String {
        ...
        if !func.parameters.is_empty() {
            ...
            output.push_str(&self.indent());
            output.push_str(&self.generate_block_commands(&func.body));
    ...
    pub fn generate_block(&mut self, block: &Block) -> String {
        ...
        self.indent_level += 1;
        output.push_str(&self.indent());
        output.push_str(&self.generate_block_commands(block));
        self.indent_level -= 1;
    ...
    fn generate_block_commands(&mut self, block: &Block) -> String {
        let mut output = String::new();
