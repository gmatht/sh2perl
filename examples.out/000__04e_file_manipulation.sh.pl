...
my $cp_result = do {
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_63 = do { "Copy successful" };
...
my $mv_result = do {
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_73 = do { "Move successful" };
...
my $rm_result = do {
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_83 = do { "Remove successful" };
...
my $mkdir_result = do {
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_93 = do { "Directory created" };
...
my $touch_result = do {
    ...
    if ($CHILD_ERROR == 0) {
        my $right_result_104 = do { "File touched" };
...
say "=== File Manipulation Commands Complete ===";
