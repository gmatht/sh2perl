...
if (-e "/dev/null") {
    ...
    while (my $line = <$fh>) {
        ...
        push @grep_filenames_179, "/dev/null";
    }
    close $fh
...
# Original bash: echo "HELLO world" | grep -i "hello"
{
    ...
    $output_180 .= 'HELLO world' . "\n";
if ( !($output_180 =~ m{\n\z}msx) ) { $output_180 .= "\n"; }
$CHILD_ERROR = 0;

        my $grep_result_180_1;
    my @grep_lines_180_1 = split /\n/msx, $output_180;
    my @grep_filtered_180_1 = grep { /hello/msxi } @grep_lines_180_1;
...
$CHILD_ERROR = 0;
    ...
    my @grep_filtered_181_1 = grep { !/line2/msx } @grep_lines_181_1;
...
$CHILD_ERROR = 0;
    ...
    my @grep_filtered_182_1 = grep { /second/msx } @grep_lines_182_1;
    my @grep_numbered_182_1;
    for my $i (0..@grep_lines_182_1-1) {
    if (scalar grep { $_ eq $grep_lines_182_1[$i] } @grep_filtered_182_1) {
    push @grep_numbered_182_1, sprintf "%d:%s", $i + 1, $grep_lines_182_1[$i];
    }
    }
...
$CHILD_ERROR = 0;
    ...
    my @grep_filtered_183_1 = grep { /match/msx } @grep_lines_183_1;
    $grep_result_183_1 = scalar @grep_filtered_183_1 . "\n";
    ...
    }
{
    ...
    $output_184 .= 'text with pattern123 in it' . "\n";
if ( !($output_184 =~ m{\n\z}msx) ) { $output_184 .= "\n"; }
$CHILD_ERROR = 0;

        my $grep_result_184_1;
    my @grep_lines_184_1 = split /\n/msx, $output_184;
    my @grep_filtered_184_1 = grep { /pattern[0-9]+/msx } @grep_lines_184_1;
    my @grep_matches_184_1;
    foreach my $line (@grep_filtered_184_1) {
    if ($line =~ /(pattern[0-9]+)/msx) {
    push @grep_matches_184_1, $1;
    }
    }
